...
echo "🧪 Running tests for Uber-Lite Lesson 4: Geospatial Indexing with H3"
echo ""
...
REQUIRED_FILES=(
    "pom.xml"
    "src/main/java/com/uberlite/GeoIndexApp.java"
    "src/main/java/com/uberlite/MetricsServer.java"
    "src/main/java/com/uberlite/RocksDBConfigSetter.java"
    "src/main/java/com/uberlite/model/DriverLocation.java"
    "src/main/java/com/uberlite/partitioner/H3Partitioner.java"
    "src/main/java/com/uberlite/processor/SpatialIndexProcessor.java"
    "src/main/java/com/uberlite/serdes/JsonSerdes.java"
    "docker-compose.yml"
)
...
APP_COUNT=$(pgrep -f "com.uberlite.GeoIndexApp" | wc -l)
...
if [ "$APP_COUNT" -gt 1 ]; then
    echo "⚠️  Found $APP_COUNT GeoIndexApp processes (should be 0 or 1)"
else
    echo "✅ GeoIndexApp processes: $APP_COUNT"
fi
