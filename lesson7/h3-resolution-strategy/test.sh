...
echo "🧪 Running tests for Uber-Lite Lesson 7: H3 Resolution Strategy"
echo ""
...
REQUIRED_FILES=(
    ...
    "src/main/java/com/uberlite/ResolutionBenchmark.java"
    "src/main/java/com/uberlite/ResolutionStrategyApp.java"
    "src/main/java/com/uberlite/ResolutionStrategyDemo.java"
...
APP_COUNT=$(pgrep -f "com.uberlite.ResolutionStrategyApp" | wc -l)
...
if [ "$APP_COUNT" -gt 1 ]; then
    echo "⚠️  Found $APP_COUNT ResolutionStrategyApp processes (should be 0 or 1)"
else
    echo "✅ ResolutionStrategyApp processes: $APP_COUNT"
fi
